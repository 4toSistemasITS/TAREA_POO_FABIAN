 ...
 */
public class sexto_quimica implements i_mejores_estudiantes{
    
    
    private String general;

    public sexto_quimica(String general) {
    ...
    public void reprobado_cuadro_honor() {
        System.out.println("el estudiante no aprobo al cuador de honor");
        }
