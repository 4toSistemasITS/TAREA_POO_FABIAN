 ...
 */
public class sexto_informatica implements i_mejores_estudiantes{
    
    private String general;
    

    public sexto_informatica(String general) {
    ...
    public void reprobado_cuadro_honor() {
        System.out.println("el estudiante no aprobo al cuadro de honor");
       }
